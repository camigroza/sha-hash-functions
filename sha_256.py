...
def sha256(message):
    # Constantele SHA-256 (primii 32 de biti ai partilor fractionare ale radacinilor patrate ale primelor 64 de numere prime)
    K = [
    ...
    # Hash-urile initiale (primii 32 de biti ai radacinilor patrate ale primelor 8 numere prime)
    H = [
    ...
    # Adaugam padding cu zerouri până la 56 bytes
